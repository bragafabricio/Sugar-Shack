...
class CatalogueItemServiceTest {
    ...
    void findByTypeGivenAType() {
        ...
        List<CatalogueItemDto> testList = service.findByType("Dark");
    ...
    void findByTypeWithNoTypeGiven() {
        ...
        List<CatalogueItemEntity> expectedAll = Arrays.asList(darkMapleType, amberMapleType);

        Mockito.when(repository.findByType("")).thenReturn(expectedAll);

        List<CatalogueItemDto> testList = service.findByType("");
